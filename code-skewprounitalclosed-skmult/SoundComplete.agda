...
sound-pr-ccut-n (uf f) g h = {!sound-pr-ccut-j f g h!}
sound-pr-ccut-n (⊸r f) g h = {!!}
sound-pr-ccut-n (⊸c Δ₀ f f₁) g h = {!!}

sound-pr-ccut-j (⊸r f) g h = {!!}
sound-pr-ccut-j (⊸l f f₁) g h = {!!}
sound-pr-ccut-j (⊸c Δ₀ f f₁) g h = {!!}
