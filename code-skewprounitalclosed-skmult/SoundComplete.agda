...
sound-ccut-b2-n (base {nothing} f refl refl) g = baseccut
...
sound-ccut-b2-j {Δ₀ = Δ₀} (base {just X} f refl refl) g =
  baseccut
  ∙ ([ lmap ` Δ₀ ∣≐]f
       (~ ass
       ∙ (i baseuf ∘ refl
         ∙ (~ ni1 ∘ refl ∙ (ass ∙ (refl ∘ ((refl ⊸ (~ f⊸id)) ∘ refl ∙ nL ∙ (ass ∙ (refl ⊸ f⊸id ∙ f⊸id ∘ refl) ∙ lid)) ∙ ~ ass) ∙ (ijL ∘ refl) ∙ lid)) ∘ refl)) ∘ refl) 
...
sound-pr-ccut-j : ∀ {T Γ Δ Δ₀ Δ₁ A A' B C}
  → (f : just A' ∣ Γ ⊢ A ⊸ B) (g : nothing ∣ Δ ⊢ A) (h : T ∣ Δ₀ ++ B ∷ Δ₁ ⊢ C)
  → sound (pr-ccut Δ₀ f g h) ≐ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h)
sound-pr-ccut-n : ∀ {T Γ Δ Δ₀ Δ₁ A B C}
  → (f : nothing ∣ Γ ⊢ A ⊸ B) (g : nothing ∣ Δ ⊢ A) (h : T ∣ Δ₀ ++ B ∷ Δ₁ ⊢ C)
  → sound (pr-ccut Δ₀ f g h) ≐ [ Δ₀ ∣ i (sound f) ∘ L⋆ Γ ]f ∘ ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h)

sound-pr-ccut-n {Δ = Δ} {Δ₀ = Δ₀} (uf {Γ} f) g h =
  proof≐
    sound (pr-ccut Δ₀ f g h)
  ≐〈 sound-pr-ccut-j f g h 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ ([ Δ₀ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h)
  ≐〈 ~ ass 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ [ Δ₀ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ~ [ Δ₀ ∣∘]f ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ∘ (L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ) ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (~ ass ∙ (~ ass ∘ refl)) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (~ lid ∙ (~ ijL ∘ refl) ∘ refl ∘ refl ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i j ∘ L ∘ sound f ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (ass ∙ (refl ∘ (~ lid ∙ (~ ass ∙ (~ (refl ⊸ f⊸id ∙ f⊸id) ∘ refl ∘ refl)))) ∘ refl ∘ refl ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i j ∘ (id ⊸ (id ⊸ id) ∘ L ∘ sound f ⊸ id) ∘ L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (refl ∘ ~ nL ∘ refl ∘ refl ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i j ∘ ((id ⊸ sound f) ⊸ (id ⊸ id) ∘ L) ∘ L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f ((refl ∘ (refl ⊸ f⊸id ∘ refl) ∙ ~ ass ∘ refl) ∙ ass ∘ refl ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i j ∘ (id ⊸ sound f) ⊸ id ∘ (L ∘ L⋆ Γ) ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (ni1 ∘ refl ∘ refl ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i (id ⊸ sound f ∘ j) ∘ (L ∘ L⋆ Γ) ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (ass ∘ refl ∙ ass) ∘ refl 〉 
    [ Δ₀ ∣ i (id ⊸ sound f ∘ j) ∘ (L ∘ L⋆ Γ) ∘ (L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ) ]f ∘ sound h
  ≐〈 [ Δ₀ ∣∘]f ∘ refl 〉 
    [ Δ₀ ∣ i (id ⊸ sound f ∘ j) ∘ (L ∘ L⋆ Γ) ]f ∘  [ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ass 〉 
    [ Δ₀ ∣ i (id ⊸ sound f ∘ j) ∘ (L ∘ L⋆ Γ) ]f ∘  ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h)
  qed≐
sound-pr-ccut-n {Γ = Γ} {Δ} {Δ₀} (⊸r f) g h =
  proof≐
    sound (ccut Δ₀ (ccut Γ g f refl) h refl)
  ≐〈 sound-ccut-n Δ₀ (ccut Γ g f refl) h refl 〉 
    [ Δ₀ ∣ i (sound (ccut Γ g f refl)) ∘ L⋆ (Γ ++ Δ) ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (refl ∘ L⋆ass Γ Δ ∙ ~ ass) ∘ refl 〉 
    [ Δ₀ ∣ i (sound (ccut Γ g f refl)) ∘ L⋆ Γ ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (i (sound-ccut-n Γ g f refl) ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i ([ Γ ∣ i (sound g) ∘ L⋆ Δ ]f ∘ sound f) ∘ L⋆ Γ ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (~ ni1 ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i (sound f) ∘ [ Γ ∣ i (sound g) ∘ L⋆ Δ ]f ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (ass ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i (sound f) ∘ ([ Γ ∣ i (sound g) ∘ L⋆ Δ ]f ⊸ id ∘ L⋆ Γ) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (refl ∘ (~ nL⋆ Γ _ ∙ (refl ∘ ∘⊸id ∙ ~ ass)) ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i (sound f) ∘ (L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (~ ass ∙ (~ ass ∘ refl) ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ i (sound f) ∘ L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (ass ∘ refl ∙ ass) ∘ refl 〉 
    [ Δ₀ ∣ i (sound f) ∘ L⋆ Γ ∘ (L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ) ]f ∘ sound h
  ≐〈 [ Δ₀ ∣∘]f ∘ refl 〉 
    [ Δ₀ ∣ i (sound f) ∘ L⋆ Γ ]f ∘ [ Δ₀ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ass 〉 
    [ Δ₀ ∣ i (sound f) ∘ L⋆ Γ ]f ∘ ([ Δ₀ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h)
  qed≐
sound-pr-ccut-n {Δ = Δ} {Δ₁}{Δ₃} (⊸c Δ₀ {Γ} {Δ₂} {A} {B} f f₁) g h =
  proof≐
    [ Δ₁ ∣ [ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ sound (pr-ccut Δ₁ f₁ g h)
  ≐〈 refl ∘ sound-pr-ccut-n f₁ g h 〉 
    [ Δ₁ ∣ [ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ ([ Δ₁ ∣ i (sound f₁) ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ ([ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h))
  ≐〈 ~ ass ∙ ~ ass 〉 
    [ Δ₁ ∣ [ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ [ Δ₁ ∣ i (sound f₁) ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ~ [ Δ₁ ∣∘]f ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ (i (sound f₁) ∘ L⋆ (Δ₀ ++ B ∷ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (~ ass) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ i (sound f₁) ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (ni2 ∘ refl) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f ass ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Δ₀ ++ B ∷ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ L⋆ass Δ₀ (_ ∷ Δ₂) ∙ ~ ass ∙  ~ ass)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ Δ₀ ∘ L ∘ L⋆ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (~ nL⋆2 Δ₀ _ ∘ refl ∘ refl)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ id ⊸ (L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ∘ L ∘ L⋆ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (ass ∘ refl ∙ ass)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (id ⊸ (L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ∘ L ∘ L⋆ Δ₂ {_}{_})) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (id⊸∘ ∙ (refl ⊸ (~ ∘⊸id)  ∘ refl) ∘ refl ∙ ass ∘ refl ∙ ass))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ (id ⊸ L⋆ Γ ∘ L ∘ L⋆ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (refl ∘ ~ L⋆LL⋆ Γ (Δ ++ Δ₃) Δ₂))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ (L⋆ Γ ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂)))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (~ ass ∙ (~ ass ∙ (~ swap⊸ ∘ refl) ∘ refl)))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (rid ∙ (ass ∘ ~ f⊸id ∙ ass) ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ (id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ L ∘ (id ⊸ id)) ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (refl ∘ ~ nL ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ ((i (sound f) ∘ L⋆ Γ) ⊸ id ⊸ (id ⊸ id) ∘ L) ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (~ ass ∙ (refl ∘ (refl ⊸ f⊸id) ∘ refl) ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ (i (sound f) ∘ L⋆ Γ) ⊸ id ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (~ ∘⊸id ∘ refl ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (((i (sound f) ∘ L⋆ Γ) ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ ((∘⊸id ∘ refl) ⊸ refl ∘ refl ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ ((L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (~ ass ∙ (~ ass ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (nL⋆ Δ₀ _ ∘ refl ∘ refl)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ ([ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ Δ₀ ∘ L ∘ L⋆ (Γ ++ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (ass ∙ ass ∙ (refl ∘ ~ (L⋆ass Δ₀ (_ ∷ Γ ++ Δ₂))))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ ([ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (~ ass) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i (sound f₁) ∘ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (ni1 ∘ refl) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ i ([ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ sound f₁) ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ass 〉 
    [ Δ₁ ∣ i ([ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ∘ sound f₁) ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂) ]f ∘ ([ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h)
  qed≐

sound-pr-ccut-j {Γ = Γ} {Δ}{Δ₀} (⊸r f) g h = 
  proof≐
    sound (ccut Δ₀ (ccut Γ g f refl) h refl)
  ≐〈 sound-ccut-j Δ₀ (ccut Γ g f refl) h refl 〉 
    [ Δ₀ ∣ sound (ccut Γ g f refl) ⊸ id ∘ L⋆ (Γ ++ Δ) ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (refl ∘ L⋆ass Γ Δ ∙ ~ ass) ∘ refl 〉 
    [ Δ₀ ∣ sound (ccut Γ g f refl) ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (sound-ccut-n Γ g f refl ⊸ refl ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ ([ Γ ∣ i (sound g) ∘ L⋆ Δ ]f ∘ sound f) ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (∘⊸id ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ [ Γ ∣ i (sound g) ∘ L⋆ Δ ]f ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (ass ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ ([ Γ ∣ i (sound g) ∘ L⋆ Δ ]f ⊸ id ∘ L⋆ Γ) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₀ ∣≐]f (refl ∘ (~ nL⋆ Γ _ ∙ (refl ∘ ∘⊸id ∙ ~ ass)) ∘ refl) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ (L⋆ Γ ∘ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ...
  ≐〈 ass 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ ([ Δ₀ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h)
  qed≐
sound-pr-ccut-j {Δ = Δ} {Δ₀} (⊸l {Γ} {Δ₁} f f₁) g h =
  proof≐
    [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ sound (pr-ccut Δ₀ f₁ g h)
  ≐〈 refl ∘ sound-pr-ccut-j f₁ g h 〉 
    [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ ([ Δ₀ ∣ sound f₁ ⊸ id ∘ L⋆ Δ₁ ]f ∘ ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h))
  ≐〈 ~ ass 〉 
    [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ [ Δ₀ ∣ sound f₁ ⊸ id ∘ L⋆ Δ₁ ]f ∘ ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h)
  ≐〈 ~ [ Δ₀ ∣∘]f ∘ refl 〉 
    [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ∘ (sound f₁ ⊸ id ∘ L⋆ Δ₁) ]f ∘ ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h)
  ≐〈 [ Δ₀ ∣≐]f lem ∘ refl 〉 
    [ Δ₀ ∣ (i (sound f) ∘ L⋆ Γ ∘ id ⊸ sound f₁) ⊸ id ∘ L⋆ (Γ ++ Δ₁) ]f ∘ ([ Δ₀ ∣ L⋆ Δ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Δ ]f ∘ sound h)
  qed≐
  where
    lem : _
    lem =
      proof≐
        L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ∘ (sound f₁ ⊸ id ∘ L⋆ Δ₁)
      ≐〈 ~ ass 〉
        L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ∘ sound f₁ ⊸ id ∘ L⋆ Δ₁
      ≐〈 ass ∘ refl 〉
        L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ (L⋆ Γ ∘ sound f₁ ⊸ id) ∘ L⋆ Δ₁
      ≐〈 refl ∘ nL⋆ Γ _ ∘ refl 〉
        L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ ([ Γ ∣ sound f₁ ]f ⊸ id ∘ L⋆ Γ) ∘ L⋆ Δ₁
      ≐〈 ~ ass ∘ refl 〉
        L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ [ Γ ∣ sound f₁ ]f ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ₁
      ≐〈 ass ∙ (refl ∘ ~ ∘⊸id) ∙ ~ ∘⊸id ∘ refl ∘ refl 〉
        ([ Γ ∣ sound f₁ ]f ∘ i (sound f) ∘ L⋆ Γ) ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ₁
      ≐〈 (ni2 ∘ refl ∙ ass ∙ (refl ∘ ~ nL⋆2 Γ _) ∙ ~ ass) ⊸ refl ∘ refl ∘ refl 〉
        (i (sound f) ∘ L⋆ Γ ∘ id ⊸ sound f₁) ⊸ id ∘ L⋆ Γ ∘ L⋆ Δ₁
      ≐〈 ass ∙ (refl ∘ ~ (L⋆ass Γ Δ₁)) 〉
        (i (sound f) ∘ L⋆ Γ ∘ id ⊸ sound f₁) ⊸ id ∘ L⋆ (Γ ++ Δ₁)
      qed≐
sound-pr-ccut-j {Δ = Δ} {Δ₁}{Δ₃} (⊸c Δ₀ {Γ} {Δ₂} {A} {B} f f₁) g h =
  proof≐
    [ Δ₁ ∣ id ⊸ [ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ sound (pr-ccut Δ₁ f₁ g h)
  ≐〈 refl ∘ sound-pr-ccut-j f₁ g h 〉 
    [ Δ₁ ∣ id ⊸ [ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ ([ Δ₁ ∣ sound f₁ ⊸ id ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ ([ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h))
  ≐〈 ~ ass ∙ ~ ass 〉 
    [ Δ₁ ∣ id ⊸ [ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ [ Δ₁ ∣ sound f₁ ⊸ id ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ~ [ Δ₁ ∣∘]f ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ (sound f₁ ⊸ id ∘ L⋆ (Δ₀ ++ B ∷ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (~ ass) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ sound f₁ ⊸ id ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (~ swap⊸ ∘ refl) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Δ₀ ++ B ∷ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f ass ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Δ₀ ++ B ∷ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ L⋆ass Δ₀ (_ ∷ Δ₂) ∙ ~ ass ∙  ~ ass)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (id ⊸ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ Δ₀ ∘ L ∘ L⋆ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (~ nL⋆2 Δ₀ _ ∘ refl ∘ refl)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ id ⊸ (L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ∘ L ∘ L⋆ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (ass ∘ refl ∙ ass)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (id ⊸ (L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ∘ L ∘ L⋆ Δ₂ {_}{_})) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (id⊸∘ ∙ (refl ⊸ (~ ∘⊸id)  ∘ refl) ∘ refl ∙ ass ∘ refl ∙ ass))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ (id ⊸ L⋆ Γ ∘ L ∘ L⋆ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (refl ∘ ~ L⋆LL⋆ Γ (Δ ++ Δ₃) Δ₂))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ (L⋆ Γ ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂)))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (~ ass ∙ (~ ass ∙ (~ swap⊸ ∘ refl) ∘ refl)))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (rid ∙ (ass ∘ ~ f⊸id ∙ ass) ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ (id ⊸ ((i (sound f) ∘ L⋆ Γ) ⊸ id) ∘ L ∘ (id ⊸ id)) ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (refl ∘ ~ nL ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ ((i (sound f) ∘ L⋆ Γ) ⊸ id ⊸ (id ⊸ id) ∘ L) ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (~ ass ∙ (refl ∘ (refl ⊸ f⊸id) ∘ refl) ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ (i (sound f) ∘ L⋆ Γ) ⊸ id ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ (~ ∘⊸id ∘ refl ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (((i (sound f) ∘ L⋆ Γ) ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (refl ∘ ((∘⊸id ∘ refl) ⊸ refl ∘ refl ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ ((L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂))) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (~ ass ∙ (~ ass ∘ refl))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ (L⋆ Δ₀ ∘ (L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (nL⋆ Δ₀ _ ∘ refl ∘ refl)) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ ([ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ Δ₀ ∘ L ∘ L⋆ (Γ ++ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ (ass ∙ ass ∙ (refl ∘ ~ (L⋆ass Δ₀ (_ ∷ Γ ++ Δ₂))))) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ ([ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂)) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (~ ass) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ sound f₁ ⊸ id ∘ [ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 [ Δ₁ ∣≐]f (~ ∘⊸id ∘ refl) ∘ refl ∘ refl 〉 
    [ Δ₁ ∣ ([ Δ₀ ∣ L⋆ Γ ⊸ id ∘ i (sound f) ⊸ id ∘ L⋆ Γ ]f ∘ sound f₁) ⊸ id ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂) ]f ∘ [ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h
  ≐〈 ass 〉 
    [ Δ₁ ∣ ([ Δ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound f) ⊸ id) ∘ L⋆ Γ ]f ∘ sound f₁) ⊸ id ∘ L⋆ (Δ₀ ++ A ⊸ B ∷ Γ ++ Δ₂) ]f ∘ ([ Δ₁ ∣ (L⋆ Δ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Δ ]f ∘ sound h)
  qed≐

sound-scut (base f refl refl) (base {just X} g refl refl) = basescut
...
sound-ccut-n {Γ = Γ₁} .(Δ₁ ++ _ ⊸ B ∷ Γ ++ Δ₀) {Δ'} f (⊸c Δ₁ {Γ} {.(Δ₀ ++ _ ∷ Δ')} {B = B} g g₁) refl | inj₁ (.(Γ ++ Δ₀) , refl , refl) | inj₂ (Δ₀ , refl , refl) =
  ...
  ≐〈 ass 〉 
    [ Δ₁ ∣ id ⊸ [ Γ ∣ [ Δ₀ ∣ i (sound f) ∘ L⋆ Γ₁ ]f ]f ]f ∘ ([ Δ₁ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘ sound g₁)
  qed≐
sound-ccut-n .Δ₁ {.(Γ ++ Δ₂)} f (⊸c Δ₁ {Γ} {Δ₂} g g₁) refl | inj₂ ([] , refl , refl) = sound-pr-ccut-n f g g₁
...
sound-ccut-j {Γ = Γ'} .(Γ ++ Γ₀) {Δ'} f (⊸l {Γ} {.(Γ₀ ++ _ ∷ Δ')} g g') refl | inj₂ (Γ₀ , refl , refl) = 
  ...
  ≐〈 (ass ∘ refl) ∙ ass 〉
    [ Γ ++ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ' ]f ∘ (i (sound g) ∘ L⋆ Γ ∘ id ⊸ sound g')
  qed≐
sound-ccut-j Δ₀ {Δ'} f (⊸c Δ₁ {Γ} {Δ₂} g g₁) p with cases++ Δ₁ Δ₀ (Γ ++ Δ₂) (_ ∷ Δ') (sym p)
sound-ccut-j .(Δ₁ ++ _ ⊸ _ ∷ Γ₀) {Δ'} f (⊸c Δ₁ {Γ} {Δ₂} g g₁) p | inj₁ (Γ₀ , refl , r) with cases++ Γ₀ Γ Δ' Δ₂ r
sound-ccut-j {Γ = Γ} .(Δ₁ ++ _ ⊸ _ ∷ Γ₀) {.(Δ₀ ++ Δ₂)} {A} f (⊸c Δ₁ {.(Γ₀ ++ A ∷ Δ₀)} {Δ₂} g g₁) refl | inj₁ (Γ₀ , refl , refl) | inj₁ (Δ₀ , refl , refl) = 
  proof≐
    [ Δ₁ ∣ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀) ⊸ id ∘ i (sound (ccut Γ₀ f g refl)) ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀) ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f lem ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ (L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)) ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣∘]f ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ]f ∘  [ Δ₁ ∣ L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ (Γ₀ ++ A ∷ Δ₀) ]f ∘ sound g₁
  ≐〈 ass 〉 
    [ Δ₁ ∣ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ]f ∘  ([ Δ₁ ∣ L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ (Γ₀ ++ A ∷ Δ₀) ]f ∘ sound g₁)
  qed≐
  where
    ...
    lem' =
      proof≐
        i (sound g) ∘ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)
      ≐〈 refl ∘ L⋆ass Γ₀ (_ ∷ Γ ++ Δ₀) 〉
        i (sound g) ∘ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ (L⋆ Γ₀ ∘ L⋆ (_ ∷ Γ ++ Δ₀))
      ≐〈 ~ ass ∙ (ass ∘ refl) 〉
        i (sound g) ∘ ([ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ Γ₀) ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 refl ∘ ~ nL⋆ Γ₀ _ ∘ refl 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ (sound f ⊸ id ∘ L⋆ Γ) ⊸ id) ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 ass 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ (sound f ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L⋆ (_ ∷ Γ ++ Δ₀))
      ≐〈 refl ∘ (refl ∘ ∘⊸id ∙ ~ ass ∘ refl) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ L⋆ Γ ⊸ id ∘ sound f ⊸ id ⊸ id ∘ L⋆ (_ ∷ Γ ++ Δ₀))
      ≐〈 refl ∘ (~ ass ∙ (ass ∙ (refl ∘ ((refl ⊸ (~ f⊸id)) ∘ refl ∙ nL ∙ (refl ∘ f⊸id ∙ ~ rid))) ∘ refl)) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ L⋆ Γ ⊸ id ∘ (id ⊸ (sound f ⊸ id) ∘ L) ∘ L⋆ (Γ ++ Δ₀))
      ≐〈 refl ∘ ((~ ass ∙ (ass ∘ refl)) ∘ refl) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ (L⋆ Γ ⊸ id ∘ id ⊸ (sound f ⊸ id)) ∘ L ∘ L⋆ (Γ ++ Δ₀))
      ≐〈 refl ∘ (refl ∘ swap⊸ ∘ refl ∘ refl) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ (id ⊸ (sound f ⊸ id) ∘ L⋆ Γ ⊸ id) ∘ L ∘ L⋆ (Γ ++ Δ₀))
      ≐〈 refl ∘ (~ ass ∘ refl ∙ ass ∘ refl ∙ ass) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ id ⊸ (sound f ⊸ id) ∘ ((L⋆ Γ ⊸ id) ∘ L ∘ L⋆ (Γ ++ Δ₀)))
      ≐〈 refl ∘ (refl ∘ L⋆LL⋆ _ [] _) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ id ⊸ (sound f ⊸ id) ∘ (id ⊸ L⋆ Γ ∘ L ∘ L⋆ Δ₀))
      ≐〈 refl ∘ (~ ass ∙ (~ ass ∙ (ass ∙ (refl ∘ ~ id⊸∘) ∘ refl) ∘ refl)) 〉
        i (sound g) ∘ (L⋆ Γ₀ ∘ id ⊸ (sound f ⊸ id ∘ L⋆ Γ) ∘ L ∘ L⋆ Δ₀ {_}{_})
      ≐〈 refl ∘ (nL⋆2 Γ₀ _ ∘ refl ∘ refl) 〉
        i (sound g) ∘ (id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ Γ₀ ∘ L ∘ L⋆ Δ₀)
      ≐〈 refl ∘ (ass ∙ (ass ∙ (refl ∘ ~ (L⋆ass Γ₀ (_ ∷ Δ₀))))) 〉
        i (sound g) ∘ (id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Γ₀ ++ A ∷ Δ₀))
      ≐〈 ~ ass 〉
        i (sound g) ∘ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      ≐〈 ~ ni2 ∘ refl 〉
        [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ i (sound g) ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      qed≐

    lem : _
    lem =
      proof≐
        L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀) ⊸ id ∘ i (sound (ccut Γ₀ f g refl)) ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)
      ≐〈 refl ∘ i (sound-ccut-j Γ₀ f g refl) ⊸ refl ∘ refl 〉
        L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀) ⊸ id ∘ i ([ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ sound g) ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)
      ≐〈 refl ∘ (~ ni1) ⊸ refl ∘ refl 〉
        L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀) ⊸ id ∘ (i (sound g) ∘ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id) ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)
      ≐〈 ~ ∘⊸id ∘ refl 〉
        (i (sound g) ∘ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)) ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)
      ≐〈 lem' ⊸ refl ∘ refl 〉
        ([ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ i (sound g) ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)) ⊸ id ∘ L⋆ (Γ₀ ++ _ ∷ Γ ++ Δ₀)
      ≐〈 ∘⊸id ∙ (refl ∘ ∘⊸id ∙ ~ ass) ∘ L⋆ass Γ₀ (_ ∷ Γ ++ Δ₀) 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ (L⋆ Γ₀ ∘ L⋆ (_ ∷ Γ ++ Δ₀))
      ≐〈 ~ ass ∙ (ass ∘ refl) 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ ([ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ⊸ id ∘ L⋆ Γ₀) ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 refl ∘ ~ nL⋆ Γ₀ _ ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ (L⋆ Γ₀ ∘ (sound f ⊸ id ∘ L⋆ Γ) ⊸ id) ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 ~ ass ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ (sound f ⊸ id ∘ L⋆ Γ) ⊸ id ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 refl ∘ ∘⊸id ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ (L⋆ Γ ⊸ id ∘ sound f ⊸ id ⊸ id) ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 ~ ass ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ L⋆ Γ ⊸ id ∘ sound f ⊸ id ⊸ id ∘ L⋆ (_ ∷ Γ ++ Δ₀)
      ≐〈 ~ ass ∙ (ass ∙ (refl ∘ ((refl ⊸ (~ f⊸id)) ∘ refl ∙ nL ∙ (refl ∘ f⊸id ∙ ~ rid)))  ∘ refl) 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ L⋆ Γ ⊸ id ∘ (id ⊸ (sound f ⊸ id) ∘ L) ∘ L⋆ (Γ ++ Δ₀)
      ≐〈 ~ ass ∙ (ass ∘ refl) ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ (L⋆ Γ ⊸ id ∘ id ⊸ (sound f ⊸ id)) ∘ L ∘ L⋆ (Γ ++ Δ₀)
      ≐〈 refl ∘ swap⊸ ∘ refl ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ (id ⊸ (sound f ⊸ id) ∘ L⋆ Γ ⊸ id) ∘ L ∘ L⋆ (Γ ++ Δ₀)
      ≐〈 (~ ass ∘ refl ∙ ass) ∘ refl ∙ ass 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ id ⊸ (sound f ⊸ id) ∘ (L⋆ Γ ⊸ id ∘ L ∘ L⋆ (Γ ++ Δ₀))
      ≐〈 refl ∘ L⋆LL⋆ Γ Δ₂ Δ₀ 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ₀ ∘ id ⊸ (sound f ⊸ id) ∘ (id ⊸ L⋆ Γ ∘ L ∘ L⋆ Δ₀)
      ≐〈 ~ ass ∙ (~ ass ∙ (ass ∙ (ass ∙ (refl ∘ (refl ∘ ~ id⊸∘))) ∘ refl) ∘ refl) 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ (L⋆ Γ₀ ∘ id ⊸ (sound f ⊸ id ∘ L⋆ Γ)) ∘ L ∘ L⋆ Δ₀
      ≐〈 refl ∘ nL⋆2 Γ₀ _ ∘ refl ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ (id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ Γ₀) ∘ L ∘ L⋆ Δ₀
      ≐〈 ~ ass ∘ refl ∘ refl ∙ ass ∙ ass 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ (L⋆ Γ₀ ∘ (L ∘ L⋆ Δ₀))
      ≐〈 refl ∘ ~ (L⋆ass Γ₀ (_ ∷ Δ₀)) 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      ≐〈 ass ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ (i (sound g) ⊸ id ∘ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f) ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      ≐〈 refl ∘ swap⊸ ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ (id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ i (sound g) ⊸ id) ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      ≐〈 ~ ass ∘ refl 〉
        L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ i (sound g) ⊸ id ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      ≐〈 swap⊸ ∘ refl ∘ refl 〉
        id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ (Γ₀ ++ A ∷ Δ₀)
      ≐〈 ass ∘ refl ∙ ass 〉
        id ⊸ [ Γ₀ ∣ sound f ⊸ id ∘ L⋆ Γ ]f ∘ (L⋆ (Γ₀ ++ A ∷ Δ₀) ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ (Γ₀ ++ A ∷ Δ₀))
      qed≐      
sound-ccut-j {Γ = Γ₁} .(Δ₁ ++ _ ⊸ B ∷ Γ ++ Δ₀) {Δ'} f (⊸c Δ₁ {Γ} {.(Δ₀ ++ _ ∷ Δ')} {B = B} g g₁) refl | inj₁ (.(Γ ++ Δ₀) , refl , refl) | inj₂ (Δ₀ , refl , refl) =
  proof≐
    [ Δ₁ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘  sound (ccut (Δ₁ ++ B ∷ Δ₀) f g₁ refl)
  ≐〈 refl ∘ sound-ccut-j (Δ₁ ++ B ∷ Δ₀) f g₁ refl 〉 
    [ Δ₁ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘  ([ Δ₁ ∣ id ⊸ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ sound g₁)
  ≐〈 ~ ass 〉 
    [ Δ₁ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘  [ Δ₁ ∣ id ⊸ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ sound g₁
  ≐〈 ~ [ Δ₁ ∣∘]f ∘ refl 〉 
    [ Δ₁ ∣ L⋆ Γ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ ∘ id ⊸ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f ass ∘ refl 〉 
    [ Δ₁ ∣ L⋆ Γ ⊸ id ∘ i (sound g) ⊸ id ∘ (L⋆ Γ ∘ id ⊸ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f) ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ nL⋆2 Γ _) ∘ refl 〉 
    [ Δ₁ ∣ L⋆ Γ ⊸ id ∘ i (sound g) ⊸ id ∘ ((id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f) ∘ L⋆ Γ) ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f (~ ass ∙ (ass ∘ refl)) ∘ refl 〉 
    [ Δ₁ ∣ L⋆ Γ ⊸ id ∘ (i (sound g) ⊸ id ∘ id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f) ∘ L⋆ Γ ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f (refl ∘ swap⊸ ∘ refl) ∘ refl 〉 
    [ Δ₁ ∣ L⋆ Γ ⊸ id ∘ (id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f (~ ass ∘ refl) ∘ refl 〉 
    [ Δ₁ ∣ L⋆ Γ ⊸ id ∘ id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ i (sound g) ⊸ id ∘ L⋆ Γ ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f (swap⊸ ∘ refl ∘ refl) ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ L⋆ Γ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣≐]f (ass ∘ refl ∙ ass) ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ∘ (L⋆ Γ ⊸ id ∘ i (sound g) ⊸ id ∘ L⋆ Γ) ]f ∘ sound g₁
  ≐〈 [ Δ₁ ∣∘]f ∘ refl 〉 
    [ Δ₁ ∣ id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ]f ∘ [ Δ₁ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘ sound g₁
  ≐〈 ass 〉 
    [ Δ₁ ∣ id ⊸ [ Γ ∣ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ]f ]f ∘ ([ Δ₁ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ∘ sound g₁)
  qed≐
sound-ccut-j .Δ₁ {.(Γ ++ Δ₂)} f (⊸c Δ₁ {Γ} {Δ₂} g g₁) refl | inj₂ ([] , refl , refl) = sound-pr-ccut-j f g g₁
sound-ccut-j {Γ = Γ₁} Δ₀ {.(Γ₀ ++ _ ⊸ _ ∷ Γ ++ Δ₂)} f (⊸c .(Δ₀ ++ x ∷ Γ₀) {Γ} {Δ₂} g g₁) refl | inj₂ (x ∷ Γ₀ , refl , refl) = 
  proof≐
    [ Δ₀ ∣  id ⊸ [ Γ₁ ∣ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ]f ∘ _
  ≐〈 refl ∘ sound-ccut-j Δ₀ f g₁ refl 〉 
    [ Δ₀ ∣  id ⊸ [ Γ₁ ∣ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ]f ∘ ([ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ∘ sound g₁)
  ≐〈 ~ ass 〉 
    [ Δ₀ ∣  id ⊸ [ Γ₁ ∣ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ]f ∘ [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ∘ sound g₁
  ≐〈 ~ [ Δ₀ ∣∘]f ∘ refl 〉 
    [ Δ₀ ∣  id ⊸ [ Γ₁ ∣ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ (sound f ⊸ id ∘ L⋆ Γ₁) ]f ∘ sound g₁
  ≐〈  [ Δ₀ ∣≐]f (~ ass ∙ (~ swap⊸ ∘ refl)) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ id ⊸ [ Γ₁ ∣ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ L⋆ Γ₁ ]f ∘ sound g₁
  ≐〈  [ Δ₀ ∣≐]f ass ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ (id ⊸ [ Γ₁ ∣ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ L⋆ Γ₁) ]f ∘ sound g₁
  ≐〈  [ Δ₀ ∣≐]f (refl ∘ ~ nL⋆2 Γ₁ _) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ (L⋆ Γ₁ ∘ id ⊸ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f) ]f ∘ sound g₁
  ≐〈  [ Δ₀ ∣≐]f (~ ass) ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ∘ id ⊸ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ sound g₁
  ≐〈 [ Δ₀ ∣∘]f ∘ refl 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ∘ [ Δ₀ ∣ id ⊸ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ sound g₁
  ≐〈 ass 〉 
    [ Δ₀ ∣ sound f ⊸ id ∘ L⋆ Γ₁ ]f ∘ ([ Δ₀ ∣ id ⊸ [ Γ₀ ∣ (L⋆ Γ ⊸ id) ∘ (i (sound g) ⊸ id) ∘ L⋆ Γ ]f ]f ∘ sound g₁)
  qed≐
