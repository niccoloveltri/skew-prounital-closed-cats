...
ccut-b2-ass-ccut-b2 : ∀ {S T Γ Δ₀ Δ₁ Λ₀ Λ₁ X Y Z}
  → (f : S ∣ Γ ⊢ ` Z)(g : nothing ∣ Δ₀ ++ Z ∷ Δ₁ ⊢b X)(h : T ∣ Λ₀ ++ X ∷ Λ₁ ⊢b Y)
  → ccut-b2 (Λ₀ ++ Δ₀) f (ccut-b Λ₀ g h) ≗ ccut-b2 Λ₀ (ccut-b2 Δ₀ f g) h
ccut-b2-ass-ccut-b2 {Δ₀ = Δ₀} {Λ₀ = Λ₀} (base {nothing} x refl refl) g h = 
  ≡-to-≗ (cong (λ x → base x refl refl) (ccut-ccut-ass-b Δ₀ Λ₀ x g h))
ccut-b2-ass-ccut-b2 {Δ₀ = Δ₀} {Λ₀ = Λ₀} (base {just x₁} x refl refl) g h = 
  ≡-to-≗ (cong (λ x → base x refl refl) (ccut-ccut-ass-b Δ₀ Λ₀ (uf-b x) g h))
ccut-b2-ass-ccut-b2 (uf f) g h = ccut-b2-ass-ccut-b2 f g h
ccut-b2-ass-ccut-b2 {Δ₀ = Δ₀} {Λ₀ = Λ₀} (⊸l f f₁) g h
  = ⊸c (lmap ` Λ₀ ++ lmap ` Δ₀) refl (ccut-b2-ass-ccut-b2 f₁ g h)
ccut-b2-ass-ccut-b2 {S} {Δ₀ = Δ₁} {Λ₀ = Λ₀} (⊸c Δ₀ f f₁) g h
  = ⊸c (lmap ` Λ₀ ++ lmap ` Δ₁ ++ asCxt S Δ₀) refl (ccut-b2-ass-ccut-b2 f₁ g h)
...
pr-ccut-ass-ccut-b2 : ∀ {S₁ S₂ T Γ Γ' Δ₀ Δ₁ Λ₀ Λ₁ A B X Y}
  → (f : S₁ ∣ Γ ⊢ A ⊸ B)(g : nothing ∣ Γ' ⊢ A) (h : S₂ ∣ Δ₀ ++ B ∷ Δ₁ ⊢ ` X) (k : T ∣ Λ₀ ++ X ∷ Λ₁ ⊢b Y)
  → pr-ccut (lmap ` Λ₀ ++ asCxt S₂ Δ₀) f g (ccut-b2 Λ₀ h k)
         ≗ ccut-b2 Λ₀ (pr-ccut Δ₀ f g h) k
pr-ccut-ass-ccut-b2 (uf f) g h k = pr-ccut-ass-ccut-b2 f g h k
pr-ccut-ass-ccut-b2 {S₂ = S₂} {Γ = Γ} {Δ₀ = Δ₀} {Λ₀ = Λ₀} (⊸r f) g h k =
  ccut-ass-ccut-b2 (ccut Γ g f refl) h k refl
pr-ccut-ass-ccut-b2 {S₂ = S₂} {Δ₀ = Δ₀} {Λ₀ = Λ₀} (⊸l f f₁) g h k =
  ⊸c (lmap ` Λ₀ ++ asCxt S₂ Δ₀) refl (pr-ccut-ass-ccut-b2 f₁ g h k)
pr-ccut-ass-ccut-b2 {S₁} {S₂} {Δ₀ = Δ₁} {Λ₀ = Λ₀} (⊸c Δ₀ f f₁) g h k =
  ⊸c (lmap ` Λ₀ ++ asCxt S₂ Δ₁ ++ asCxt S₁ Δ₀) refl (pr-ccut-ass-ccut-b2 f₁ g h k)

ccut-ass-ccut-b2 {Δ₀ = Δ₀} {Δ₁} {A = A} f (base {Γ = Γ} x refl x₂) h refl with  cases++-lmap ` Δ₀ (A ∷ Δ₁) Γ x₂
ccut-ass-ccut-b2 {Δ₀ = .(lmap ` Λ₁)} {.(lmap ` Λ₂)} {Λ₀ = Λ₀} {Λ₃} {.(` X)} f (base {nothing} {Γ = .(Λ₁ ++ X ∷ Λ₂)} x refl refl) h refl | Λ₁ , X ∷ Λ₂ , refl , refl , refl 
  rewrite cases++-lmap-refl ` (Λ₀ ++ Λ₁) (X ∷ Λ₂ ++ Λ₃) = ccut-b2-ass-ccut-b2 f x h
ccut-ass-ccut-b2 {Δ₀ = .(lmap ` Λ₁)} {.(lmap ` Λ₂)} {Λ₀ = Λ₀} {Λ₃} {.(` X)} f (base {just x₁} {Γ = .(Λ₁ ++ X ∷ Λ₂)} x refl refl) h refl | Λ₁ , X ∷ Λ₂ , refl , refl , refl 
  rewrite cases++-lmap-refl ` (Λ₀ ++ x₁ ∷ Λ₁) (X ∷ Λ₂ ++ Λ₃) =
    ccut-b2-ass-ccut-b2 {Δ₀ = x₁ ∷ Λ₁} f (uf-b x) h
    ∙ cong-ccut-b2 Λ₀ h (ccut-b2-uf-b2 f x)  
ccut-ass-ccut-b2 {Δ₀ = Δ₀} f (uf g) h eq with cases∷ Δ₀ eq
ccut-ass-ccut-b2 {nothing} {Δ₀ = .[]} f (uf g) h refl | inj₁ (refl , refl , refl) = ccut-ass-ccut-b2-s f g h
ccut-ass-ccut-b2 {just x} {Δ₀ = .[]} f (uf g) h refl | inj₁ (refl , refl , refl) = ccut-ass-ccut-b2-s f g h
ccut-ass-ccut-b2 {Δ₀ = .(_ ∷ Γ₀)} f (uf g) h refl | inj₂ (Γ₀ , refl , refl) = ccut-ass-ccut-b2 f g h refl
ccut-ass-ccut-b2 {Δ₀ = Δ₀} {Δ₁} f (⊸l {Γ} {Δ} g g₁) h eq with  cases++ Δ₀ Γ Δ₁ Δ eq
ccut-ass-ccut-b2 {Δ₀ = Δ₀} {.(Γ₀ ++ Δ)} {Λ₀ = Λ₀} {Λ₁} {A} f (⊸l {.(Δ₀ ++ A ∷ Γ₀)} {Δ} {A₁} {B} g g₁) h refl | inj₁ (Γ₀ , refl , refl)
  rewrite cases++-inj₁ (lmap ` Λ₀) Δ₀ (A ∷ Γ₀ ++ Δ ++ lmap ` Λ₁) (A₁ ⊸ B) | cases++-inj₁ Δ₀ Γ₀ (Δ ++ lmap ` Λ₁) A = refl
ccut-ass-ccut-b2 {Δ₀ = .(Γ ++ Γ₀)} {Δ₁} {Λ₀ = Λ₀} {Λ₁} {A} f (⊸l {Γ} {.(Γ₀ ++ A ∷ Δ₁)} {A₁} {B} g g₁) h refl | inj₂ (Γ₀ , refl , refl)
  rewrite cases++-inj₁ (lmap ` Λ₀) (Γ ++ Γ₀) (A ∷ Δ₁ ++ lmap ` Λ₁) (A₁ ⊸ B) | cases++-inj₂ Γ₀ Γ (Δ₁ ++ lmap ` Λ₁) A =
    ⊸c (lmap ` Λ₀) refl (ccut-ass-ccut-b2 f g₁ h refl)
ccut-ass-ccut-b2 {Δ₀ = Δ₁} {Δ₂} {A = A} f (⊸c Δ₀ {Γ} {Δ₃} g g₁) h eq with  cases++ Δ₀ Δ₁ (Γ ++ Δ₃) (A ∷ Δ₂) (sym eq)
ccut-ass-ccut-b2 {Δ₀ = .(Δ₀ ++ _ ⊸ _ ∷ Γ₀)} {Δ₂} {A = A} f (⊸c Δ₀ {Γ} {Δ₃} g g₁) h eq | inj₁ (Γ₀ , refl , q) with cases++ Γ₀ Γ Δ₂ Δ₃ q
ccut-ass-ccut-b2 {S₂ = S₂} {Γ = _} {.(Δ₀ ++ A₁ ⊸ B ∷ Γ₀)} {.(Γ₀' ++ Δ₃)} {Λ₀ = Λ₀} {Λ₁} {A} f (⊸c Δ₀ {.(Γ₀ ++ A ∷ Γ₀')} {Δ₃} {A₁} {B} g g₁) h refl | inj₁ (Γ₀ , refl , refl) | inj₁ (Γ₀' , refl , refl)
  rewrite cases++-inj₁ (lmap ` Λ₀ ++ asCxt S₂ Δ₀) Γ₀ (A ∷ Γ₀' ++ Δ₃ ++ lmap ` Λ₁) (A₁ ⊸ B) | cases++-inj₁ Γ₀ Γ₀' (Δ₃ ++ lmap ` Λ₁) A = refl
ccut-ass-ccut-b2 {S₂ = S₂} {Γ = _} {.(Δ₀ ++ A₁ ⊸ B ∷ Γ ++ Γ₀')} {Δ₂} {Λ₀ = Λ₀} {Λ₁} {A} f (⊸c Δ₀ {Γ} {.(Γ₀' ++ A ∷ Δ₂)} {A₁} {B} g g₁) h refl | inj₁ (.(Γ ++ Γ₀') , refl , refl) | inj₂ (Γ₀' , refl , refl)
  rewrite cases++-inj₁ (lmap ` Λ₀ ++ asCxt S₂ Δ₀) (Γ ++ Γ₀') (A ∷ Δ₂ ++ lmap ` Λ₁) (A₁ ⊸ B) | cases++-inj₂ Γ₀' Γ (Δ₂ ++ lmap ` Λ₁) A =
    ⊸c (lmap ` Λ₀ ++ asCxt S₂ Δ₀) refl (ccut-ass-ccut-b2 {Δ₀ = Δ₀ ++ B ∷ Γ₀'} f g₁ h refl)
ccut-ass-ccut-b2 {S₂ = S₂} {Δ₀ = .Δ₀} {.(Γ ++ Δ₃)} {Λ₀ = Λ₀} {Λ₁} {.(A ⊸ B)} f (⊸c Δ₀ {Γ} {Δ₃} {A} {B} g g₁) h refl | inj₂ ([] , refl , refl)
  rewrite cases++-inj₂ [] (lmap ` Λ₀ ++ asCxt S₂ Δ₀) (Γ ++ Δ₃ ++ lmap ` Λ₁) (A ⊸ B) = pr-ccut-ass-ccut-b2 f g g₁ h
ccut-ass-ccut-b2 {S₁} {S₂} {Γ = Γ₁} {Δ₁} {.(Γ₀ ++ A ⊸ B ∷ Γ ++ Δ₃)} {Λ₀ = Λ₀} {Λ₁} {.x} f (⊸c .(Δ₁ ++ x ∷ Γ₀) {Γ} {Δ₃} {A} {B} g g₁) h refl | inj₂ (x ∷ Γ₀ , refl , refl)
  rewrite cases++-inj₂ (x ∷ Γ₀) (lmap ` Λ₀ ++ asCxt S₂ Δ₁) (Γ ++ Δ₃ ++ lmap ` Λ₁) (A ⊸ B) =
    ⊸c (lmap ` Λ₀ ++ asCxt S₂ Δ₁ ++ asCxt S₁ Γ₁ ++ Γ₀) refl (ccut-ass-ccut-b2 f g₁ h refl)
...
pr-ccut-ass-pr-ccut : ∀ {S₁ S₂ T Γ Γ' Δ₀ Δ₁ Δ Λ₀ Λ₁ A A' B B' C}
  → (f : S₁ ∣ Γ ⊢ A ⊸ B)(g : nothing ∣ Γ' ⊢ A)
  → (f' : S₂ ∣ Δ₀ ++ B ∷ Δ₁ ⊢ A' ⊸ B') (g' : nothing ∣ Δ ⊢ A') (h : T ∣ Λ₀ ++ B' ∷ Λ₁ ⊢ C)
  → pr-ccut (Λ₀ ++ asCxt S₂ Δ₀) f g (pr-ccut Λ₀ f' g' h)
         ≗ pr-ccut Λ₀ (pr-ccut Δ₀ f g f') g' h
...
pr-ccut-ass-ccut {S₂ = S₂} {Γ = Γ} {.(Δ₀ ++ A ⊸ B ∷ Γ₀')} {.(Γ₀'' ++ Δ₁)} {Δ = Δ} {Λ₀} {Λ₁} {A' = A'} f (⊸c Δ₀ {.(Γ₀' ++ A' ∷ Γ₀'')} {Δ₁} {A} {B} g g₁) h k refl | inj₁ (Γ₀' , refl , refl) | inj₁ (Γ₀'' , refl , refl)
  rewrite cases++-inj₁ (Λ₀ ++ asCxt S₂ Δ₀) Γ₀' (A' ∷ Γ₀'' ++ Δ₁ ++ Δ ++ Λ₁) (A ⊸ B) | cases++-inj₁ Γ₀' Γ₀'' (Δ₁ ++ Δ ++ Λ₁) A' = refl
pr-ccut-ass-ccut {S₂ = S₂} {Γ = Γ} {.(Δ₀ ++ A ⊸ B ∷ Γ₁ ++ Γ₀'')} {Γ₂} {Δ = Δ} {Λ₀} {Λ₁} {A' = A'} f (⊸c Δ₀ {Γ₁} {.(Γ₀'' ++ A' ∷ Γ₂)} {A} {B} g g₁) h k refl | inj₁ (.(Γ₁ ++ Γ₀'') , refl , refl) | inj₂ (Γ₀'' , refl , refl)
  rewrite cases++-inj₁ (Λ₀ ++ asCxt S₂ Δ₀) ( Γ₁ ++ Γ₀'') (A' ∷ Γ₂ ++ Δ ++ Λ₁) (A ⊸ B) | cases++-inj₂ Γ₀'' Γ₁ (Γ₂ ++ Δ ++ Λ₁) A' =
    ⊸c (Λ₀ ++ asCxt S₂ Δ₀) refl (pr-ccut-ass-ccut {Γ₀ = Δ₀ ++ B ∷ Γ₀''} f g₁ h k refl)
pr-ccut-ass-ccut {S₂ = S₂} {Γ = Γ} {.Δ₀} {.(Γ₁ ++ Δ₁)} {Δ = Δ} {Λ₀} {Λ₁} {A' = .(A ⊸ B)} f (⊸c Δ₀ {Γ₁} {Δ₁} {A} {B} g g₁) h k refl | inj₂ ([] , refl , refl)
  rewrite cases++-inj₂ [] (Λ₀ ++ asCxt S₂ Δ₀) (Γ₁ ++ Δ₁ ++ Δ ++ Λ₁) (A ⊸ B)
    = pr-ccut-ass-pr-ccut f g g₁ h k
pr-ccut-ass-ccut {S₁} {S₂} {Γ = Γ} {Γ₀} {.(Γ₀' ++ A ⊸ B ∷ Γ₁ ++ Δ₁)} {Δ = Δ} {Λ₀} {Λ₁} {A' = .x} f (⊸c .(Γ₀ ++ x ∷ Γ₀') {Γ₁} {Δ₁} {A} {B} g g₁) h k refl | inj₂ (x ∷ Γ₀' , refl , refl)
  rewrite cases++-inj₂ (x ∷ Γ₀') (Λ₀ ++ asCxt S₂ Γ₀) (Γ₁ ++ Δ₁ ++ Δ ++ Λ₁) (A ⊸ B)
    = ⊸c (Λ₀ ++ asCxt S₂ Γ₀ ++ asCxt S₁ Γ ++ Γ₀') refl (pr-ccut-ass-ccut f g₁ h k refl)


pr-ccut-ass-pr-ccut (uf f) g f' g' h = pr-ccut-ass-pr-ccut f g f' g' h
pr-ccut-ass-pr-ccut {S₂ = S₂} {Γ = Γ} {Δ₀ = Δ₀} {Λ₀ = Λ₀} (⊸r f) g f' g' h =
  pr-ccut-ass-ccut (ccut Γ g f refl) f' g' h refl
pr-ccut-ass-pr-ccut {S₂ = S₂} {Δ₀ = Δ₀} {Λ₀ = Λ₀} (⊸l f f₁) g f' g' h =
  ⊸c (Λ₀ ++ asCxt S₂ Δ₀) refl (pr-ccut-ass-pr-ccut f₁ g f' g' h)
pr-ccut-ass-pr-ccut {S₁} {S₂} {Δ₀ = Δ₁} {Λ₀ = Λ₀} (⊸c Δ₀ f f₁) g f' g' h =
  ⊸c (Λ₀ ++ asCxt S₂ Δ₁ ++ asCxt S₁ Δ₀) refl (pr-ccut-ass-pr-ccut f₁ g f' g' h)
